...
var app = (function (exports) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*deleteTodo*/ ctx[3](/*t*/ ctx[5].id))) /*deleteTodo*/ ctx[3](/*t*/ ctx[5].id).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*todos*/ 1 && t0_value !== (t0_value = /*t*/ ctx[5].text + "")) set_data_dev(t0, t0_value);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*newTodoText*/ ctx[1]);
    			append_dev(div, t2);
    			append_dev(div, button);
    			append_dev(main, t4);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*newTodoText*/ 2 && input.value !== /*newTodoText*/ ctx[1]) {
    				set_input_value(input, /*newTodoText*/ ctx[1]);
    			}

    			if (dirty & /*deleteTodo, todos*/ 9) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addTodo = () => {
    		$$invalidate(0, todos = [{ id: v4(), text: newTodoText }, ...todos]);
    	...
    	return [todos, newTodoText, addTodo, deleteTodo, input_input_handler];
    }
